...
class Accommodatie(models.Model):
    ...
    homepage = models.CharField(db_column='AccHomepage', max_length=200, blank=True, null=True)  
    ...
    picturefront = models.IntegerField(db_column='Acc_PictureFront', blank=True, null=True)  
    acc_intro = models.TextField(db_column='Acc_Intro', blank=True, null=True)  
    acc_intro_nl = models.TextField(db_column='Acc_Intro_NL', blank=True, null=True)  
    acc_intro_de = models.TextField(db_column='Acc_Intro_DE', blank=True, null=True)  
    acc_intro_fr = models.TextField(db_column='Acc_Intro_FR', blank=True, null=True)  
    ...
    aantaldagen = models.IntegerField(db_column='AantalDagen', blank=True, null=True)  
    accaddsort = models.IntegerField(db_column='AccAddSort', blank=True, null=True)  
    verkoopprijs = models.CharField(max_length=15, blank=True, null=True)
    ground = models.CharField(max_length=10, blank=True, null=True)
    bground = models.CharField(max_length=10, blank=True, null=True)
